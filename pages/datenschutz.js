...
import { dsvgoMenuItem } from '../components/Navigation/MenuItems';
...
const DSVGOPage = ({ postData }) => {
  ...
  //             <MenuTitle
  //                 title={pageTitle}
  //                 compressorValue={0.595}
  //                 imageUrl={(postData.coverimage !== null) ? postData.coverimage.url : null}
  ...
  //         </LeftSide>
  //         <RightSide
  //             passSizeToChildOnDrag={updateSideSize} >
